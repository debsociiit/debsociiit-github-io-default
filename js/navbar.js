    ...
    <div class="topnav" id="navbar">
      ...
      <div class="pages">
        <a href="index.html" id="home" class="inactive"
          ><img src="../resources/home_icon.svg" alt="Home Icon"> HOME</a
        >
        <a href="upcoming.html" id="upcoming" class="inactive"
          ><img src="../resources/upcoming_icon.svg" alt="Upcoming Icon"> UPCOMING</a
        >
        <a href="team.html" id="team" class="inactive"
          ><img src="../resources/team_icon.svg" alt="Team Icon"> THE TEAM</a
        >
        <a href="about.html" id="archive" class="inactive"
          ><img src="../resources/archive_icon.svg" alt="Archive Icon"> ARCHIVE</a
        >
      </div>
      <div class="right">
        <a href="javascript:void(0)" onclick="toggle()" class="arrow"
          ><img id="iconPic" src="../resources/Up.svg"
        /></a>
      </div>
    </div>
      `;
